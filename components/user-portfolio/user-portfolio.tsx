...
export function UserPortfolio({ username }: UserPortfolioProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Projects Section - Card Grid, matches demo */}
      {portfolioData.projects && portfolioData.projects.length > 0 && (
        <section id="projects" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-black">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {portfolioData.projects.map((project, idx) => {
                // Pick a color for the title based on index for demo-like effect
                let titleClass = "bg-gradient-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent";
                if (idx === 1) titleClass = "bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent";
                if (idx === 2) titleClass = "bg-gradient-to-r from-cyan-300 to-teal-400 bg-clip-text text-transparent";
                return (
                  <div
                    key={project.id}
                    className="bg-gray-900/80 border border-gray-800 rounded-2xl p-8 shadow-lg flex flex-col justify-between group transition-all hover:border-blue-500"
                  >
                    {/* Project Title */}
                    ...
                    <div className="mb-6">
                      <p className="text-gray-100 font-semibold mb-2">
                        {project.status === "completed" && "Completed Project"}
